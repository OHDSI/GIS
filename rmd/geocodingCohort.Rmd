...
``` {r eval=FALSE}
geocodedCohort <- geocodeAddresses(addressTable = cohortWithAddresses)
```

### Step 3. Import Geocoded Cohort to gaiaDB Database
``` {r eval=FALSE}
importCohortTable(gaiaConnectionDetails = gaiaConnectionDetails,
                  cohort = geocodedCohort)
```

### Step 4. Filter Cohort using PostGIS Functionality
