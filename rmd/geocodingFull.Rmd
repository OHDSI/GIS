...
``` {r eval=FALSE}
# ToDO manual rbind between two tables, or a function that handles converting OMOP lat/lon columns?
fullyGeocodedLocation <- geocodedLocation
if (!is.null(alreadyGeocodedLocation)) {
  # TODO ensure that alreadyGeocodedLocation has same schema as geocodedLocation
  #   -all lowercase
  #   -lat and lon column converted into geometry column  
