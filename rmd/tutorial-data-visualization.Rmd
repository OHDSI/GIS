...
This page renders the contents of the synthetic OMOP + GIS/SDOH dataset described in [OMOP Data Description](tutorial-data-description.html). Source: [`syntheticDataGIS/createSimpleSyntheticSet.sql`](https://github.com/OHDSI/GIS/blob/main/syntheticDataGIS/createSimpleSyntheticSet.sql).
