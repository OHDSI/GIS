...
┌─────────────────────────────────────────────────────────────────┐
│                       gaiaCore                                   │
│  • R package for data processing                                 │
│  • Geospatial transformations                                    │
│  • Privacy-preserving location handling                          │
│  • OMOP integration logic                                        │
└────────────────────────────┬────────────────────────────────────┘
                             │
                             ▼
┌─────────────────────────────────────────────────────────────────┐
...
```
gaiaDb + Patient Locations → gaiaCore
    Input:
...
- **gaiaCatalog**: Discovery
- **gaiaDb**: Storage & staging
- **gaiaCore**: Processing & integration
...
| Patient locations | Geocoded coords | External_Exposure | OMOP table |
| Residence periods | Date ranges | Location_History | OMOP table |
...
├── gaiaCore container (R + Plumber API)
