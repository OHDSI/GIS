...
This package is a vital extension of the OMOP CDM, addressing the growing need to contextualize healthcare data with external environmental and societal factors. Developed and maintained by the [GIS Working Group](https://ohdsi.github.io/GIS/index.html), this package provides vocabularies, scripts, and documentation for terminology integration into existing OHDSI vocabularies.
...
## 1.1. Vocabularies
- **OMOP GIS Vocabulary**
Standardizes geographical terminologies and spatial data, supporting geospatial epidemiology, healthcare accessibility studies, and population health research. The OMOP GIS vocabulary is a compilation of terminologies related to geography, boundaries, and spatial elements. 
