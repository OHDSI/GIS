...
The OHDSI GIS Workgroup aims to introduce new vocabularies, infrastructure, tooling, and CDM extension tables that will allow researchers to incorporate place-based datasets into their OMOP-shaped databases to enhance their evidence-generating workflows.
...
The overarching goal of the OHDSI GIS Workgroup is to develop vocabularies, software, and standards for incorporating place-based data into the OMOP CDM and present these work outputs back to the OHDSI community. We reach these goals through development in the five key areas below. 
...
- OMOP-specific data transformations
