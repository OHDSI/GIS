...
CREATE TABLE @cdmDatabaseSchema.location_history  (location_id integer NOT NULL,
...
CREATE TABLE @cdmDatabaseSchema.external_exposure  (external_exposure_id integer NOT NULL,
